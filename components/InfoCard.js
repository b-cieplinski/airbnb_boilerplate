...
const InfoCard = ({img, location, title, description, star, price, total, long, lat}) => {
  return (
    <div className="flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transform transition duration-100 ease-out first:border-t mb-2 rounded-2xl">
